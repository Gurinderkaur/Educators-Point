...
<h2 align="center">Update/Delete Subject</h2><p>&nbsp;</p>
<form id="form1" name="form1" method="post" action="">
	...
	$res=mysqli_query($conn,$q) or die("Error in query" . mysqli_error($conn));
			...
			{
				 print "<table class='mynewtab'width='750' align='center' cellspacing='0' cellpadding='10'>
		...
		while($x=mysqli_fetch_array($res))
		{
			...
			<td>$x[2]</td>
			<td><a href='updatesub.php?subjectid=$x[0]'>Update</a></td>
			<td><a href='delsub.php?subjectid=$x[0]'>Delete</a></td>
